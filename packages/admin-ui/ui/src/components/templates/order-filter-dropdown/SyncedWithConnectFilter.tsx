...
const SyncedWithConnectFilter = ({ open, filter, setFilter }: RefFilterProps) => {
      ...
      >
        ...
        >
          <div className="flex items-center">
            ...
            <input className="hidden" checked={open} readOnly type="checkbox" title="Synced with connect" />
            <span className="ml-2">{t('order-filter-dropdown-synced-with-connect', 'Synced with connect')}</span>
          </div>
          {open && (
        ...
        <RadixCollapsible.Content className="w-full">
          ...
          >
            ...
            <input
              ...
              title="Synced"
            />
            <span>{t('order-filter-dropdown-synced', 'Synced')}</span>
          </div>
          ...
          >
            ...
            <input
              ...
              title="Not synced"
            />
            <span>{t('order-filter-dropdown-not-synced', 'Not synced')}</span>
          </div>
...
export default SyncedWithConnectFilter;
