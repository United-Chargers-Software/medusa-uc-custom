...
const RefFilter = ({ open, filter, setFilter }: RefFilterProps) => {
      ...
      >
        ...
        >
          <div className="flex items-center">
            ...
            <span className="ml-2">{t('order-filter-dropdown-ref', 'Referral code')}</span>
          </div>
          {open && (
        ...
        <RadixCollapsible.Content className="w-full">
          ...
          >
            ...
            <input type="radio" className="hidden" name="ref-filter" checked={filter === true} readOnly />
          ...
          >
            ...
            <input type="radio" className="hidden" name="ref-filter" checked={filter === false} readOnly />
            <span>Without Referral Code</span>
          </div>
