...
import { useAdminGetSession, useAdminRefundPayment } from 'medusa-react';
    ...
    mutate(
      {
        ...
        note: data.note?.concat(`%%${refundedBy_email}%%${refundedBy_name}`),
      },
      {
        onSuccess: async res => {
          notification(
            ...
            {isSystemPayment && (
              <div className="inter-small-regular bg-orange-5 rounded-rounded mb-6 flex p-4 text-orange-50">
                ...
                <div className="flex flex-col">
                  <span className="inter-small-semibold">{t('refund-attention', 'Attention!')}</span>
                  {t(
